...
const DesktopLayout = ({ data, openModal, isMobile }) => {
  ...
  const { mainFeaturedNews, secondaryFeaturedNews1, secondaryFeaturedNews2, otherNews, allNews } = articles;
              ...
              <div className="flex justify-between items-center mb-1 p-4 pb-0">
                <div className="relative w-2/5">
                 ...
                 <button className="focus:outline-none flex-shrink-0 cursor-pointer hover:opacity-80 transition-opacity" aria-label="Videos On Demand">
                    <img loading="lazy" src={isDarkTheme ? botonDemandUrl_dark : botonDemandUrl_light} alt="Botón para ver Videos On Demand" className="h-12 object-contain" />
                  </button>
              </div>
